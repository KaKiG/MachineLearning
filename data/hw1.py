...
# lin_reg2.fit_gd(SNP_data[:, :2], exp_data[:, 394].reshape(-1, 1))
...
coeffs3my = []
lin_ridge_my = MR.Ridge(alpha=20)
coeffs3my = []
lin_ridge_my.fit_gd(SNP_data, exp_data[:, 394])
...
# coeffs4my = []
# lin_ridge_my2.fit_sgd(SNP_data, exp_data[:, 394])
